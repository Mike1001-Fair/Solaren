...
try {
	...
	var rs = Solaren.Execute("ListCompensation", "Iнформацiю не знайдено");
} catch (ex) {
...
for (var i=0; !rs.EOF; i++) {
	...
	ResponseText.push('<TR><TD ALIGN="RIGHT">' + rs.Fields("ContractPAN") +
...
ResponseText.push('<TR><TH ALIGN="LEFT" COLSPAN="6">Всього: ' + i +
