const [SbmBtn, DelBtn, RestoreBtn, AddBtn] = ['SbmBtn', 'DelBtn', 'RestoreBtn', 'AddBtn'].map(id => document.getElementById(id)),
...
function AddOrderItem() {
	...
	cellContents = [
		...
		'<button type="button" class="RemoveBtn" title="Видалити" onclick="RemoveOrderItem(this)">✖</button>'
	];
